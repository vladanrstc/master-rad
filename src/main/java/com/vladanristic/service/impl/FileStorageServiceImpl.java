...
import com.vladanristic.pojo.FileStorageProperties;
...
public class FileStorageServiceImpl implements FileStorageService {
    ...
    public String storeFile(MultipartFile file) throws Exception {
        // Normalize file name
        String fileName = (int)Math.floor(Math.random()*(999999-100000+1)+100000) + "-" + StringUtils.cleanPath(file.getOriginalFilename());
